#!/usr/bin/env bash
# PARAMS: name, login=admin, password, version=4.0.3, plugins
set -e
...
sandbox/bin/pip install --download-cache=$HOME/eggs ZopeSkel==2.17 PIL==1.1.7 PasteDeploy==1.3.4 Paste==1.6
