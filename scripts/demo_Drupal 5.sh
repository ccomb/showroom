...
mv drupal-$drupal_version drupal5
cp drupal5/sites/default/default.settings.php drupal5/sites/default/settings.php
sed -i "s/^\$db_url.*/\$db_url='mysql:\/\/$db_user:$db_pass@$db_host:$db_port\/$db_name';/" drupal5/sites/default/settings.php
